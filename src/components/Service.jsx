  ...
  return (
    <div className="bg-transparent text-white py-16 px-6">
      ...
      <div className="text-center mb-16 relative">
        ...
        <h1 className="text-transparent text-[3rem] lg:text-[10rem] uppercase font-bold stroke-text tracking-wider font-poppins">
          Services
        </h1>
          ...
          <ul className="space-y-10 mt-3">
            <li className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xl">
                  UX Research involves gathering and analyzing user insights to
                  refine the design and development of user-centric products and
                  experiences.
                </p>
              </div>
            </li>
            <li className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xl">
                  Prototypes are interactive versions of a product designed to
                  test UX ideas and ensure usability.
                </p>
              </div>
            </li>
            <li className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xl">
                  Interaction Design focuses on creating intuitive and engaging
                  experiences between users and digital interfaces.
                </p>
              </div>
            </li>
          </ul>
          ...
          <ul className="space-y-10 mt-3">
            <li className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xl">
                  E-Commerce websites involve online buying and selling,
                  providing seamless client access and a secure shopping
                  experience.
                </p>
              </div>
            </li>
            <li className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xl">
                  Blog websites serve as a platform for individuals or
                  organizations to share thoughts, insights, and expertise with
                  their audience.
                </p>
              </div>
            </li>
            <li className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xl">
                  Portfolio websites showcase a company's products and services,
                  helping to attract clients and market offerings.
                </p>
              </div>
            </li>
          </ul>
          ...
          <ul className="space-y-10 mt-3">
            <li className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xl">
                  Logo design is the art of crafting a visually captivating
                  symbol that represents a brand's identity and values.
                </p>
              </div>
            </li>
            <li className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xl">
                  Engaging YouTube thumbnails capture attention, boost views,
                  and make your content more clickable.
                </p>
              </div>
            </li>
            <li className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xl">
                  Branding creates a unique identity that connects with
                  consumers, helping you stand out and build lasting
                  relationships.
                </p>
              </div>
            </li>
      ...
      <div className="bg-black text-white py-10 flex flex-col items-center justify-center space-y-12 px-4">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-center leading-snug md:leading-normal">
          ...
          <br className="hidden md:block" /> Let’s connect.
        </h2>
