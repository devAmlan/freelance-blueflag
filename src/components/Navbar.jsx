...
function Navbar() {
  ...
  return (
    <nav className="bg-transparent text-white py-4 fixed top-0 left-0 w-full shadow-md z-10 backdrop-blur-3xl px-8 lg:px-24">
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        <ul className="hidden md:flex space-x-8">
          <li>
            <Link to="/" className="hover:text-customPurple">
              Home
            </Link>
          </li>
          <li>
            <Link to="/service" className="hover:text-customPurple">
              Service
            </Link>
          </li>
          <li>
            <Link to="/contact" className="hover:text-customPurple">
              Contact
            </Link>
          </li>
          <li>
            <Link to="/work" className="hover:text-customPurple">
              {" "}
              Our Work
            </Link>
          </li>
          <li>
            <Link to="/about" className="hover:text-customPurple">
              About Us
            </Link>
          </li>
        </ul>
